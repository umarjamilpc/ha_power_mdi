...
- **Source power unit** setting (Watts or Kilowatts) — how to interpret the source entity
- Full conversion matrix with **Display unit**:
  - Source W → Display kW (÷ 1000)
  - Source kW → Display kW (as-is)
  - Source kW → Display W (× 1000)
  - Source W → Display W (as-is)
